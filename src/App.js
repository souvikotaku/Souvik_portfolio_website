  ...
  return (
    <div className="App" style={{ background: "#9ACD32" }}>
          ...
          >
            ...
            <div className="col-md-6 col-lg-4 mb-5">
              <div
                className="portfolio-item mx-auto"
                data-bs-toggle="modal"
                data-bs-target="#portfolioModal17"
                style={{
                  boxShadow: "rgba(0, 0, 0, 0.35) 0px 5px 15px",
                }}
              >
                <div className="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                  <div className="portfolio-item-caption-content text-center text-white">
                    <p>Bwstory clone app (React native/node/express/mongo)</p>
                    <i className="fas fa-plus fa-3x" />
                  </div>
                </div>
                <img
                  className="img-fluid"
                  src="/img/portfolio/bwstorythumb.png"
                  alt="..."
                />
              </div>
            </div>
            <div className="col-md-6 col-lg-4 mb-5">
              <div
                className="portfolio-item mx-auto"
                data-bs-toggle="modal"
                data-bs-target="#portfolioModal18"
                style={{
                  boxShadow: "rgba(0, 0, 0, 0.35) 0px 5px 15px",
                }}
              >
                <div className="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                  <div className="portfolio-item-caption-content text-center text-white">
                    <p>Movie Search Dashboard app (React)</p>
                    <i className="fas fa-plus fa-3x" />
                  </div>
                </div>
                <img
                  className="img-fluid"
                  src="/img/portfolio/moviedashback.jpg"
                  alt="..."
                />
              </div>
            </div>
      ...
      <div
        ...
        id="portfolioModal17"
        tabIndex={-1}
        aria-labelledby="portfolioModal17"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-xl">
          <div className="modal-content">
              ...
              <div className="container">
                <div className="row justify-content-center">
                  <div className="col-lg-8">
                    {/* Portfolio Modal - Title*/}
                    <h2 className="portfolio-modal-title text-secondary text-uppercase mb-0">
                      Bwstory clone app (React native/node/express/mongo)
                    </h2>
                    {/* Icon Divider*/}
                    <div className="divider-custom">
                      <div className="divider-custom-line" />
                    ...
                    >
                      Its a full stack app which is a clone of the bwstory app
                      on play store that i made for interview purpose.
                    </p>
                    <div className="btn-group">
                      <a
                        href="https://github.com/souvikotaku/bwstory_clone"
                        className="btn btn-primary btn-lg "
                        role="button"
                        target="_blank"
                      >
                      ...
                      <a
                        href="https://drive.google.com/file/d/1qiP66rhsKWzNkmJ4RMnuKzE5GlRJLgwv/view?usp=drive_link"
                        className="btn btn-secondary btn-lg "
                        role="button"
                        target="_blank"
                      >
      ...
      <div
        ...
        id="portfolioModal18"
        tabIndex={-1}
        aria-labelledby="portfolioModal18"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-xl">
          <div className="modal-content">
              ...
              <div className="container">
                <div className="row justify-content-center">
                  <div className="col-lg-8">
                    ...
                    >
                      Its a movie search react app which i made for interview
                      purpose.
                    </p>
                    <div className="btn-group">
                      <a
                        href="https://github.com/souvikotaku/movienewapp"
                        className="btn btn-primary btn-lg "
                        role="button"
                        target="_blank"
                      >
                      ...
                      <a
                        href="https://moviedashboardsearch.netlify.app/"
                        className="btn btn-secondary btn-lg "
                        role="button"
                        target="_blank"
                      >
